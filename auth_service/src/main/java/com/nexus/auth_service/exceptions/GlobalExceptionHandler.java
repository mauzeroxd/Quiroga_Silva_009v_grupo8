package com.nexus.auth_service.exceptions;

import com.nexus.auth_service.dtos.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleRemote(RemoteServiceException ex, HttpServletRequest request) {
        ErrorResponse error = ErrorResponse.builder()
                ...
                .error("Remote Error").message(ex.getMessage()).path(request.getRequestURI()).build();
